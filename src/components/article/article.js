...
*/
// const({ open, close }) = expandButton;
const articles = document.querySelector(".articles");

// Step 1
function articleMaker(articleObj) {
  const articleTitle = articleObj.title;
  const articleDate = articleObj.date;
  const paragraph1 = articleObj.firstParagraph;
  const paragraph2 = articleObj.secondParagraph;
  const paragraph3 = articleObj.thirdParagraph;
